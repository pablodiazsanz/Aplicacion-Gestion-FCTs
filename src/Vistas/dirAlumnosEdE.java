...
public class dirAlumnosEdE extends JFrame implements Vistas{
	...
	public dirAlumnosEdE() {
		...
		btnExit_1.setIcon(new ImageIcon(dirAlumnosEdE.class.getResource("/img/volver.png")));
		...
		btnBorrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				miControlador.directorBorrarAlumno();
			}
		});
		...
		lblNewLabel_1.setBounds(30, 227, 329, 16);
		panelEliminar.add(lblNewLabel_1);
		
		txtId = new JTextField();
		txtId.setColumns(10);
		txtId.setBounds(383, 224, 170, 21);
