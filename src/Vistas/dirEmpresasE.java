...
public class dirEmpresasE extends JFrame implements Vistas{
	...
	public dirEmpresasE() {
		...
		btnBorrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				miControlador.directorBorrarEmpresa();
			}
		});
		btnBorrar.setBounds(230, 324, 141, 65);
		panelEliminar.add(btnBorrar);
		
		lblNewLabel = new JLabel("Confirme el CIF de la empresa que desea borrar");
		lblNewLabel.setBounds(30, 227, 298, 16);
