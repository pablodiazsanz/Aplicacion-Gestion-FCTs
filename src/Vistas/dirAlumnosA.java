...
public class dirAlumnosA extends JFrame implements Vistas{
	...
	public dirAlumnosA() {
		...
		btnExit_1.setIcon(new ImageIcon(dirAlumnosA.class.getResource("/img/volver.png")));
		...
		lblquDeseaHacer = new JLabel("ANEXOS");
		lblquDeseaHacer.setFont(new Font("Lucida Grande", Font.PLAIN, 21));
		lblquDeseaHacer.setBounds(265, 6, 81, 65);
