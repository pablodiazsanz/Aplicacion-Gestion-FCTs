...
public class empAlumnos extends JFrame implements Vistas{
	...
	public empAlumnos() {
		...
		table.setBounds(254, 134, 602, 451);
		panel.add(table);
		...
		btnConsultar.setIcon(new ImageIcon(empAlumnos.class.getResource("/img/consultar.png")));
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				miControlador.empresaAlumnosBuscar();
			}
		});
		btnBuscar.setIcon(new ImageIcon(empAlumnos.class.getResource("/img/buscar.png")));
