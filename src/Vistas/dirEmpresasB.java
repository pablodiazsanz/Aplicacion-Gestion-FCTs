...
public class dirEmpresasB extends JFrame implements Vistas{
	...
	public dirEmpresasB() {
		...
		lblquEmpresaDesea = new JLabel("�Qu� empresa desea buscar?");
		lblquEmpresaDesea.setBounds(63, 91, 178, 16);
