...
public class dirAlumnosEdA extends JFrame implements Vistas{
	...
	public dirAlumnosEdA() {
		...
		btnExit_1.setIcon(new ImageIcon(dirAlumnosEdA.class.getResource("/img/volver.png")));
		...
		btnInsertar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				miControlador.directorInsertarAlumno();
			}
		});
