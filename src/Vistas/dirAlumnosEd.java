...
public class dirAlumnosEd extends JFrame implements Vistas{
	...
	public dirAlumnosEd() {
		...
		btnExit_1.setIcon(new ImageIcon(dirAlumnosEd.class.getResource("/img/volver.png")));
		...
		btnEliminar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				miControlador.directorAlumnoEditarEliminar();
			}
		});
		btnEliminar.setBounds(202, 313, 210, 65);
		panelAnadir.add(btnEliminar);
		btnEliminar.setIcon(new ImageIcon(dirAlumnosEd.class.getResource("/img/eliminar.png")));
		
		btnModificar = new JButton("Modificar Alumno");
		btnModificar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				miControlador.directorAlumnoEditarModificar();
			}
		});
		btnModificar.setBounds(202, 213, 210, 65);
		panelAnadir.add(btnModificar);
		btnModificar.setIcon(new ImageIcon(dirAlumnosEd.class.getResource("/img/modificar.png")));
		
		btnAnadir = new JButton("A�adir Alumno");
		btnAnadir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				miControlador.directorAlumnoEditarAnadir();
			}
		});
		btnAnadir.setBounds(202, 115, 210, 65);
		panelAnadir.add(btnAnadir);
		btnAnadir.setIcon(new ImageIcon(dirAlumnosEd.class.getResource("/img/anadir.png")));
	}
