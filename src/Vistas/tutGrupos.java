...
public class tutGrupos extends JFrame implements Vistas{
	...
	public tutGrupos() {
		...
		btnConsultar.setIcon(new ImageIcon(tutGrupos.class.getResource("/img/consultar.png")));
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				miControlador.tutorGruposBuscar();
			}
		});
		btnBuscar.setIcon(new ImageIcon(tutGrupos.class.getResource("/img/buscar.png")));
		...
		addWindowListener(new WindowAdapter() {
			public void windowActivated(WindowEvent e) {
				table.setModel(miModelo.getTablaTutGrupos());
			}
		});
	}
